   ...
   <soapenv:Body>
      <urn:ZFM_ABBYY_FILE_SAVE><I_CONTENT>" + req[0] + @"</I_CONTENT>
         ...
         <I_OBJTYPE>" + req[3] + @"</I_OBJTYPE>
            ...
            {
                System.Console.WriteLine(we.Message + " " + we.InnerException);
                Console.ReadLine();
                return "ERROR: " + we.Message + " " + we.InnerException;
            }
            catch (Exception e)
            {
        ...
        public HttpWebRequest CreateSOAPWebRequest()
        {
            ...
            //Making Web Request  
            HttpWebRequest Req = (HttpWebRequest)WebRequest.Create(@"http://erp-pp1.msk.aeroflot.ru:8052/sap/bc/srt/rfc/sap/zfm_abbyy_file_save/300/zfm_abbyy_file_save/zfm_abbyy_file_save?MessageId=" + messageID);
